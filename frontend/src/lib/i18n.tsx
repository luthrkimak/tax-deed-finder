...
const translations = {
  pt: {
    ...
    field_status: 'Status',
    // Auth
    auth_welcome_back: 'Entrar no BidLand',
    auth_sign_in_sub: 'Enviaremos um código de 6 dígitos para o seu email.',
    auth_send_code: 'Enviar código',
    auth_sending: 'Enviando…',
    auth_code_sent_pre: 'Código enviado para',
  ...
  en: {
    ...
    field_status: 'Status',
    // Auth
    auth_welcome_back: 'Sign in to BidLand',
    auth_sign_in_sub: "We'll send a 6-digit code to your email.",
    auth_send_code: 'Send code',
    auth_sending: 'Sending…',
    auth_code_sent_pre: 'Code sent to',
    auth_code_label: 'Code',
    auth_code_placeholder: '000000',
    auth_verify: 'Verify',
    auth_verifying: 'Verifying…',
    auth_resend: 'Resend code',
    auth_back: 'Change email',
  },
  es: {
    nav_search: 'Búsqueda',
    nav_favorites: 'Favoritos',
    ...
    field_status: 'Estado',
    // Auth
    auth_welcome_back: 'Ingresar a BidLand',
    auth_sign_in_sub: 'Te enviaremos un código de 6 dígitos a tu email.',
    auth_send_code: 'Enviar código',
    auth_sending: 'Enviando…',
    auth_code_sent_pre: 'Código enviado a',
    auth_code_label: 'Código',
    auth_code_placeholder: '000000',
    auth_verify: 'Verificar',
    auth_verifying: 'Verificando…',
    auth_resend: 'Reenviar código',
    auth_back: 'Cambiar email',
  },
