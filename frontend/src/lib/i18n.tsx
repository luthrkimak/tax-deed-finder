...
const translations = {
  pt: {
    ...
    auth_sign_in_sub: 'Entre na sua conta.',
    auth_create_account: 'Criar conta',
    auth_create_sub: 'Comece a acompanhar leilões hoje.',
    auth_password: 'Senha',
    auth_loading: 'Aguarde…',
    auth_sign_in_btn: 'Entrar',
    auth_create_btn: 'Criar conta',
    auth_check_email: 'Verifique seu email para confirmar o cadastro.',
    auth_wrong_creds: 'Email ou senha incorretos.',
    auth_already_account: 'Já tem conta? Entrar',
    auth_no_account: 'Não tem conta? Criar conta',
  },
  en: {
    nav_search: 'Search',
    ...
    auth_create_sub: 'Start tracking auctions today.',
  ...
  es: {
    ...
    auth_create_sub: 'Empieza a rastrear subastas hoy.',
    auth_password: 'Contraseña',
    auth_loading: 'Cargando…',
    auth_sign_in_btn: 'Ingresar',
    auth_create_btn: 'Crear cuenta',
    auth_check_email: 'Verifica tu email para confirmar el registro.',
    auth_wrong_creds: 'Email o contraseña incorrectos.',
    auth_already_account: '¿Ya tienes cuenta? Ingresar',
